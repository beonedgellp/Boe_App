...
import './Badges.css';
import { riskToLabel, riskToTone, lifecycleDisplayLabel, lifecycleTone } from '../riskMapping';

/* ------------------------------------------------------------------ */
/* RiskBadge                                                          */
/* ------------------------------------------------------------------ */

export function RiskBadge({ riskLabel, size = 'md' }: any) {
...
export function LifecycleBadge({ stage, size = 'md' }: any) {
...
export function StatusBadge({ status, size = 'md' }: any) {
