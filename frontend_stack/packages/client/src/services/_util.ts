...
export function setSessionTokens({ user, accessToken, refreshToken, scope = 'client' }: any) {
...
export async function apiRequest(path, { method = 'GET', body, auth = true, scope = 'client' }: any = {}) {
