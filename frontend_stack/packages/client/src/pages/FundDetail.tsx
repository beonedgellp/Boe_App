...
import { AllocationRing, PieChart3D, LineComparisonChart, DonutChart } from '../components/Charts.tsx';
import { useAppConfig } from '../hooks/useAppConfig.ts';
import { isComponentEnabled } from '@beonedge/shared/appConfig.ts';
import { fmtMoney, fmtNum, fmtPct } from '../utils/format.ts';
import { formatReturnPct, formatNavDate, returnTone } from '../utils/fundDisplay.ts';
import MoneyValue from '@beonedge/shared/components/MoneyValue.tsx';
