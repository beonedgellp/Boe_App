...
import * as fundsApi from '../services/fundsApi.ts';
import * as researchApi from '../services/researchApi.ts';
import { useAppConfig } from '../hooks/useAppConfig.ts';
import { isComponentEnabled } from '@beonedge/shared/appConfig.ts';
import { fmtMoney } from '../utils/format.ts';
import { RiskBadge } from '@beonedge/shared/components/Badges.tsx';
import { SectorMiniBar } from '@beonedge/shared/components/SectorMiniBar.tsx';
import { LineComparisonChart } from '../components/Charts.tsx';
import { fundMonogram, formatReturnPct, formatNavDate, returnTone } from '../utils/fundDisplay.ts';
...
function FundCard({ fund, onNotify, index }) {
...
function FeaturedCard({ fund, index }) {
  const navigate = useNavigate();
  return (
