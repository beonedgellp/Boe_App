...
export function AllocationRing({ data, size = 92, stroke = 12, gap = 2 }: any) {
...
export function PieChart({ data, size = 200 }: any) {
...
export function PieChart3D({ data, size = 200, depth = 16 }: any) {
