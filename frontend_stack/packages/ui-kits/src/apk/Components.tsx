...
// ---------- Top app bar ----------
function ApkAppBar({ title, leftIcon, onLeft, rightIcon, onRight, hairline = true }: any) {
  return (
...
// ---------- Bottom tab bar ----------
function ApkBottomNav({ active, onChange }: any) {
  const tabs = [
...
// ---------- Dashboard ----------
function ApkDashboard({ onOpenFund, onTab }: any) {
  return (
...
// ---------- Explore ----------
function ApkExplore({ onOpenFund }: any) {
  return (
    <div className="apk-screen">
...
// ---------- Fund detail ----------
function ApkFundDetail({ onBack, onStartSip, onLumpsum }: any) {
  return (
...
// ---------- Start SIP sheet ----------
function ApkStartSipSheet({ open, onClose, onConfirm }: any) {
...
// ---------- Profile ----------
function ApkProfile({ onLogout }: any) {
  return (
    <div className="apk-screen">
