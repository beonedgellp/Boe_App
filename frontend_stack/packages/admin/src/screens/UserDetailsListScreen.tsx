...
import { initials, displayRole, fmtInt } from '../helpers/formatters';
import './admin-screens-shared.css';

export default function UserDetailsListScreen({ onUserDetail }: any) {
  ...
  function SortHeader({ label, column, className }: any) {
