...
function KycStatusBadge({ status }: any) {
  const map = {
...
function KycReviewPanel({ row, onClose, onDecision, busy }: any) {
...
export default function KycReviewScreen({ rows = [], stats = {}, loading = false, onUserDetail }: any) {
