...
export default function AumDisplayFields({ form, setForm }: any) {
  ...
  function sortSeries() {
    setForm((s) => ({
      ...s,
      performanceSeries: [...(s.performanceSeries || [])].sort((a, b) => new Date(a.date).getTime() - new Date(b.date).getTime()),
    }));
  }
