  ...
  return (
    <nav className={`web-nav ${scrolled ? 'is-scrolled' : ''}`}>
      <div className="web-nav-inner">
        <a className="web-nav-brand" href="#"><img src="../../assets/logo.svg" alt="BeOnEdge" height="28"/></a>
...
function SignupForm({ open, onClose, onSubmit }) {
...
function SubmittedScreen({ onClose }) {
  return (
    <div className="web-modal">
      <div className="web-modal-card">
        ...
        <div className="web-app-handoff">
          <div className="web-app-handoff-mark"><img src="../../assets/logo-mark.svg" width="48" alt="BeOnEdge mark"/></div>
          <div>
    ...
    <footer id="disclosures" className="web-foot">
      <div className="web-foot-inner">
        <div className="web-foot-brand">
          <img src="../../assets/logo-on-dark.svg" height="26" alt="BeOnEdge"/>
...
Object.assign(window, { WebsiteNav, MarketPulse, Hero, Philosophy, FundShelf, HowItWorks, SignupForm, SubmittedScreen, Footer });
